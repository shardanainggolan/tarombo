...
@section('title', 'Daftar Manuskrip - Yayasan Scriptura Indonesia')
        ...
        <div class="card-datatable table-responsive pt-0">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="head-label">
                    <h5 class="card-title mb-0">Daftar Manuskrip</h5>
                </div>
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group">
                            <a href="{{ route('admin.manuscript.create') }}" class="btn btn-secondary create-new btn-primary waves-effect waves-light">
                                <span>
            ...
            <table class="datatables table table-sm" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="tw-flex">
                                <a href="{{ route('admin.manuscript.edit', $data->id) }}">
        ...
        $('.datatables').on('click', '.delete-record', function() {
            ...
            .then(res => {
                if(res.isConfirmed) {
                    axios({
                        method: 'delete',
                        url: '{{ route('admin.manuscript.destroy', '') }}/' + id,
                        responseType: 'json'
                    })
