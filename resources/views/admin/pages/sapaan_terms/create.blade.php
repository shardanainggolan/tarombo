...
<div class="container">
    ...
    <form action="{{ route("admin.sapaan_terms.store") }}" method="POST">
        @csrf
        <div class="form-group">
            <label for="term">Term:</label>
            <input type="text" name="term" id="term" class="form-control" value="{{ old("term") }}" required>
        </div>
