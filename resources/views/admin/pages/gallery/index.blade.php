...
@section('title', 'Daftar Galeri - Elite Plafon')
        ...
        <div class="card-datatable table-responsive pt-0">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group">
                            <a href="{{ route('admin.gallery.create') }}" class="btn btn-secondary create-new btn-primary waves-effect waves-light">
                                <span>
            ...
            <table class="datatables table table-sm" style="width: 100%;">
                <thead>
                    <tr>
                        <th>Nama</th>
                        <th class="text-center" style="width: 25%;">Kategori</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if($data->category)
                            <span class="badge bg-label-primary text-uppercase">{{ $data->category->name }}</span>
                            @endif
                        </td>
                        <td class="text-center">
                            @if($data->status == 1)
