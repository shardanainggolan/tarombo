...
@section('title', 'Daftar Kategori Galeri - Yayasan Scriptura Indonesia')
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group">
                            <a href="{{ route('admin.gallery.category.create') }}" class="btn btn-secondary create-new btn-primary waves-effect waves-light">
                                <span>
            ...
            <table class="datatables table table-sm" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="tw-flex">
                                <a href="{{ route('admin.gallery.category.edit', $data->id) }}">
        ...
        $('.datatables').on('click', '.delete-record', function() {
            ...
            .then(res => {
                if(res.isConfirmed) {
                    axios({
                        method: 'delete',
                        url: '{{ route('admin.gallery.category.destroy', '') }}/' + id,
                        responseType: 'json'
                    })
