...
@section('title', 'Istilah Partuturan - Tarombo')
@section('styles')
        ...
        <div class="card-datatable table-responsive pt-0">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="head-label">
                    <h5 class="card-title mb-0">Istilah Partuturan</h5>
                </div>
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group">
                            <a href="{{ route('admin.partuturan-terms.create') }}" class="btn btn-secondary create-new btn-primary waves-effect waves-light">
                                <span>
...
<script>
    $(document).ready(function () {
        $('.datatables').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.partuturan-terms.index') }}",
            columns: [
        ...
        $('.datatables').on('click', '.delete-record', function() {
            ...
            Swal.fire({
                title: "Apakah Anda yakin menghapus istilah ini?",
            ...
            .then(res => {
                if(res.isConfirmed) {
                    axios({
                        method: 'delete',
                        url: '{{ route('admin.partuturan-terms.destroy', '') }}/' + id,
                        responseType: 'json'
                    })
