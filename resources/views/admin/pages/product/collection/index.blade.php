...
@section('title', 'Daftar Koleksi Produk - Yayasan Scriptura Indonesia')
        ...
        <div class="card-datatable table-responsive pt-0">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="head-label">
                    <h5 class="card-title mb-0">Daftar Koleksi Produk</h5>
                </div>
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons btn-group flex-wrap">
                        <div class="btn-group">
                            <a href="{{ route('admin.product.collection.create') }}" class="btn btn-secondary create-new btn-primary waves-effect waves-light">
                                <span>
                                    <i class="ti ti-plus me-sm-1"></i>
                                    <span class="d-none d-sm-inline-block">
                                        Tambah Koleksi Produk
                                    </span>
                                </span>
                            </a>
                        </div>
            ...
            <table class="datatables table table-sm" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="tw-flex">
                                <a href="{{ route('admin.product.collection.edit', $data->id) }}">
        ...
        $('.datatables').on('click', '.delete-record', function() {
            ...
            .then(res => {
                if(res.isConfirmed) {
                    axios({
                        method: 'delete',
                        url: '{{ route('admin.product.collection.destroy', '') }}/' + id,
                        responseType: 'json'
                    })
